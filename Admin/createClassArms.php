...
<?php include 'includes/title.php';?>
  ...
  <script>
    // No need for AJAX here for creation, keep for future use if needed
  </script>
</head>
                  ...
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        if ($num > 0){
                          ...
                          if(isset($row['classId']) && $row['classId'] == $rows['Id']) echo ' selected';
                          echo '>'.$rows['className'].'</option>';
                              }
                                  echo '</select>';
                              }
                            ?>  
                        ...
                        <input type="text" class="form-control mb-3" required name="classArmName" value="<?php echo isset($row['classArmName']) ? $row['classArmName'] : ''; ?>" placeholder="Enter Section Name">
                        </div>
                    </div>
                      <?php
                    if (isset($Id))
